...
pub(crate) fn spawn_command(
    ...
    // pocket-codex: all stdio is piped; when the exec server runs inside a GUI
    // host process (no console), a console-subsystem child would otherwise open
    // a visible console window per sandboxed fs command.
    #[cfg(windows)]
